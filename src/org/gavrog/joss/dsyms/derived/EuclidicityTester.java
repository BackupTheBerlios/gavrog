 ...
 * 
 * @author Olaf Delgado
 * @version $Id: EuclidicityTester.java,v 1.1 2005/07/15 21:08:14 odf Exp $
 */
public class EuclidicityTester {
    ...
    private boolean checkSubgroupCount(FpGroup G, int index, int expected) {
        ...
        // --- allow an average of 1000 choice moves per expected result
        actions.setMaximalNumberOfChoices(expected * 1000);
