...
public class TestTraversal extends TestCase {
    ...
    public void testTraversal1() {
        ...
        Assert.assertEquals(new Edge(-1, one), trav.next());
        Assert.assertEquals(new Edge(0, two), trav.next());
        Assert.assertEquals(new Edge(1, three), trav.next());
        Assert.assertEquals(new Edge(0, four), trav.next());
        Assert.assertEquals(new Edge(1, five), trav.next());
        Assert.assertEquals(new Edge(0, six), trav.next());
    }
    ...
    public void testTraversal2() {
        ...
        Assert.assertEquals(new Edge(-1, one), trav.next());
        Assert.assertEquals(new Edge(2, two), trav.next());
        Assert.assertEquals(new Edge(1, three), trav.next());
        Assert.assertEquals(new Edge(2, four), trav.next());
        Assert.assertEquals(new Edge(1, five), trav.next());
        Assert.assertEquals(new Edge(2, six), trav.next());
    }
}
